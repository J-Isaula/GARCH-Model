...
que es el modelo `ARCH(p)` propuesto, inicialmente, por Engle. Además, la varianza $h_t$ puede modelarse mediante un proceso auto regresivo de orden $p$. `AR(p)` en las variables $u_t = \epsilon_t^2$.
