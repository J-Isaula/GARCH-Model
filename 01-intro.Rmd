...
Antes de que te de dolor de cabeza mirar las fórmulas matemáticas, la buena noticoa es que puedes implementarlas en Python fácilmente.
...
sp_price = pd.read_csv('/Users/juanisaulamejia/Documents/2025/Book project using bookdown/Data/SP500.csv')
```
